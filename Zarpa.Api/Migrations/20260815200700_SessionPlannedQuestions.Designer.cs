...
{
    [DbContext(typeof(ZarpaDbContext))]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zarpa.Api.Data.Entities.LicenseTopicEntity", b =>
                {
            ...
            modelBuilder.Entity("Zarpa.Api.Data.Entities.PasswordResetTokenEntity", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Zarpa.Api.Data.Entities.LicenseTopicEntity", b =>
                {
                    ...
                    b.HasOne("Zarpa.Api.Data.Entities.TopicEntity", "Topic")
                        .WithMany()
            ...
            modelBuilder.Entity("Zarpa.Api.Data.Entities.PasswordResetTokenEntity", b =>
                {
                    b.HasOne("Zarpa.Api.Data.Entities.UserEntity", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Zarpa.Api.Data.Entities.SessionAnswerEntity", b =>
                {
                    b.HasOne("Zarpa.Api.Data.Entities.AnswerEntity", "ChosenAnswer")
                        .WithMany()
