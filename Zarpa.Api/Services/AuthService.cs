...
using Zarpa.Api.Utilities.Verification;
using Zarpa.Shared.Constants;
using Zarpa.Shared.Constants.Email;
using Zarpa.Shared.Dtos;

namespace Zarpa.Api.Services
{
    public class AuthService(ZarpaDbContext context, TokenService tokenService, PasswordService passwordService, IConfiguration configuration, IEmailService emailService)
    {
