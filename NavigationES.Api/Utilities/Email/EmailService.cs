...
namespace NavigationES.Api.Utilities.Email
{
    ...
    // NavigationES placeholders — set real values (server, credentials) before going live.
    public class EmailService : IEmailService
    {
        ...
        public async Task<bool> SendEmailAsync(EmailMessageModel emailMessage)
        {
            try
            {
                ...
                var senderEmail = _configuration["EmailSettings:SenderEmail"] ?? "contact@navigationes.example";
